...
def train(text_files, checkpoints_path, log_path):
    ...
    epoch_size = testlen // (BATCHSIZE * SEQLEN)
    ...
    # training loop
    for x, y_, epoch in txt.rnn_minibatch_sequencer(codetext, BATCHSIZE, SEQLEN, nb_epochs=1000000000, nb_batches=nb_batches):
        ...
        if step % _50_BATCHES == 0 and len(valitext) > 0:
            ...
            vali_x, vali_y, _ = next(txt.rnn_minibatch_sequencer(valitext, bsize, VALI_SEQLEN, 1, bsize))  # all data in 1 batch
...
if __name__ == "__main__":
    ...
    train(text_files, checkpoints_path, log_path)
