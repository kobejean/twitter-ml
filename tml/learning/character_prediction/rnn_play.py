...
def play(meta_graph_path, author, count=1000000000, topn=ALPHASIZE):
    ...
    with tf.Session() as sess:
        ...
        for i in range(count):
            ...
            c = txt.sample_from_probabilities(yo, topn=topn)
...
if __name__ == "__main__":
    ...
    play(meta_graph_path, author, count=1000000000, topn=ALPHASIZE)
